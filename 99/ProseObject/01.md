CodersNote=this first rough version remakes the text into basic prose object components, and adds the =[G/Z/*] widgets to knit them back together.  We also make a few parameter changes.
